...
OCF_LE_SET_ADVERTISING_SET_RANDOM_ADDRESS = 0x0035
OCF_LE_SET_EXT_ADVERTISING_PARAMETERS = 0x0036
OCF_LE_SET_EXT_ADVERTISING_DATA = 0x0037
OCF_LE_SET_EXT_SCAN_RESPONSE_DATA = 0x0038
OCF_LE_SET_EXT_ADVERTISING_ENABLE = 0x0039
OCF_LE_READ_MAX_ADVERTISING_DATA_LEN = 0x003A
OCF_LE_READ_NUM_SUPPORTED_ADVERTISING_SETS = 0x003B
OCF_LE_REMOVE_ADVERTISING_SET = 0x003C
OCF_LE_CLEAR_ADVERTISING_SET = 0x003D
OCF_LE_SET_PERIODIC_ADVERTISING_PARAMETERS = 0x003E
OCF_LE_SET_PERIODIC_ADVERTISING_DATA = 0x003F
OCF_LE_SET_PERIODIC_ADVERTISING_ENABLE = 0x0040
OCF_LE_SET_EXT_SCAN_PARAMETERS = 0x0041
OCF_LE_SET_EXT_SCAN_ENABLE = 0x0042
OCF_LE_EXT_CREATE_CONN = 0x0043
OCF_LE_PERIODIC_ADVERTISING_CREATE_SYNC = 0x0044
OCF_LE_PERIODIC_ADVERTISING_CREATE_SYNC_CANCEL = 0x0045
OCF_LE_PERIODIC_ADVERTISING_TERM_SYNC = 0x0046
OCF_LE_ADD_DEVICE_TO_PERIODIC_ADVERTISER_LIST = 0x0047
OCF_LE_REMOVE_DEVICE_FROM_PERIODIC_ADVERTISER_LIST = 0x0048
OCF_LE_CLEAR_PERIODIC_ADVERTISER_LIST = 0x0049
OCF_LE_READ_PERIODIC_ADVERTISER_LIST_SIZE = 0x004A
OCF_LE_READ_TRANSMIT_POWER = 0x004B
OCF_LE_READ_RF_PATH_COMPENSATION = 0x004C
OCF_LE_WRITE_RF_PATH_COMPENSATION = 0x004D
...
EVT_LE_PERIODIC_ADVERTISING_SYNC_ESTABLISHED = 0x0E
EVT_LE_PERIODIC_ADVERTISING_REPORT = 0x0F
EVT_LE_PERIODIC_ADVERTISING_SYNC_LOST = 0x10
EVT_LE_SCAN_TIMEOUT = 0x11
EVT_LE_ADVERTISING_SET_TERM = 0x12
EVT_LE_SCAN_REQUEST_RECEIVED = 0x13
EVT_LE_CH_SEL_ALGO = 0x14
